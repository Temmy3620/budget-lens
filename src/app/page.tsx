			...
			<main className="relative z-10">
				...
				<section className="max-w-7xl mx-auto px-6 pt-16 pb-24 lg:pt-24 lg:pb-32 flex flex-col lg:flex-row items-center gap-16">
					<div className="flex-1 space-y-8 text-center lg:text-left">
						<div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-violet-500/30 bg-violet-500/10 text-xs font-semibold text-violet-400 tracking-wide">
					...
					<div className="flex-1 w-full max-w-xl lg:max-w-none relative">
						...
						{/* ダミーダッシュボード画面 */}
						<div className="rounded-2xl border border-white/10 bg-[#080d28]/70 backdrop-blur-2xl p-6 lg:p-8 shadow-[0_20px_50px_rgba(3,6,22,0.6)] space-y-8 select-none">
							...
							<div className="space-y-6">
								<div className="space-y-2">
									...
									<div className="h-3 w-full bg-slate-900 rounded-full overflow-hidden p-[1px]">
										<div className="h-full rounded-full bg-gradient-to-r from-violet-600 to-[#00d2ff] w-[78%] relative shadow-[0_0_10px_rgba(0,210,255,0.5)]" />
									</div>
								...
								<div className="space-y-2">
									...
									<div className="h-3 w-full bg-slate-900 rounded-full overflow-hidden p-[1px]">
										<div className="h-full rounded-full bg-gradient-to-r from-emerald-500 to-teal-400 w-[45%] shadow-[0_0_10px_rgba(52,211,153,0.4)]" />
									</div>
								...
								<div className="space-y-2">
									...
									<div className="h-3 w-full bg-slate-900 rounded-full overflow-hidden p-[1px]">
										<div className="h-full rounded-full bg-gradient-to-r from-[#ffd280] to-[#f43f5e] w-[60%] shadow-[0_0_10px_rgba(244,63,94,0.4)]" />
									</div>
				...
				<section className="border-t border-white/5 bg-[#05081d]/40 py-24 relative">
					<div className="max-w-4xl mx-auto px-6 text-center space-y-12">
						...
						<div className="p-8 rounded-2xl border border-[#00d2ff]/20 bg-gradient-to-r from-cyan-950/10 to-indigo-950/10 backdrop-blur-md max-w-3xl mx-auto space-y-4">
				...
				<section className="max-w-7xl mx-auto px-6 py-24 lg:py-32 space-y-16">
					...
					<div className="grid md:grid-cols-3 gap-8">
						{/* 特徴1 */}
						<div className="rounded-2xl border border-white/5 bg-[#070b20]/50 p-8 hover:border-violet-500/30 transition-all duration-300 group flex flex-col justify-between">
							<div className="space-y-6">
				...
				<section className="max-w-5xl mx-auto px-6 py-24 flex flex-col md:flex-row items-center gap-12">
					...
					<div className="w-full md:w-[320px] shrink-0 flex items-center justify-center">
						<div className="relative p-8 rounded-3xl border border-emerald-500/20 bg-emerald-500/5 shadow-[0_0_40px_rgba(16,185,129,0.1)] text-center space-y-4">
