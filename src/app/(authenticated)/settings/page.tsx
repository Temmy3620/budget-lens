...
import { resetAllUserDataAction } from "./actions";
...
export default function SettingsPage() {
	...
	return (
		<main className="flex-1 p-4 md:p-8 max-w-4xl mx-auto w-full space-y-6">
			...
			{/* アカウント削除 (Danger Zone) カード */}
			<div className="rounded-2xl border border-rose-500/20 bg-rose-950/5 p-6 md:p-8 backdrop-blur-md shadow-xl space-y-6 mt-6">
				<div className="space-y-4">
